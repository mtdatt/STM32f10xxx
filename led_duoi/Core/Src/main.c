...
//		  osDelay(1000);
//	  }
//	  GPIOA->BSRR = (uint32_t)GPIO_PIN_All << 16u;
//	  osDelay(1000);
//	  for(int i = 0; i < 4; i++)
//	  	  {
//	  		  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3 >> i , 1);
//	  		  osDelay(1000);
//	  	  }
//	  GPIOA->BSRR = (uint32_t)GPIO_PIN_All << 16u;
//	 	  osDelay(1000);
...
//	  for(int i = 0; i < 4; i++)
//	  	  {
//	  		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6 >> i , 1);
//	  		  osDelay(1000);
//	  		// HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6 >> i , 0);
//	  	  }
//	  	  GPIOB->BSRR = (uint32_t)GPIO_PIN_All << 16u;
//	  	  osDelay(1000);
//	  	  for(int i = 0; i < 4; i++)
//	  	  	  {
...
//		  for(int i = 0; i < 6; i++)
//		  	  {
//		  		  HAL_GPIO_WritePin(GPIOA, (GPIO_PIN_0 << i) | (GPIO_PIN_0 << (i+2)), 1);
//		  		  osDelay(1000);
//			  	  GPIOA->BSRR = (uint32_t)GPIO_PIN_All << 16u;
//			  	  osDelay(1000);
//
...
//		  for(int i = 0; i < 6; i++)
//		  		  	  {
//		  		  		  HAL_GPIO_WritePin(GPIOA, (GPIO_PIN_7  >> i) | (GPIO_PIN_7 >> (i+2)), 1);
//		  		  		  osDelay(1000);
//		  			  	  GPIOA->BSRR = (uint32_t)GPIO_PIN_All << 16u;
//		  			  	  osDelay(1000);
//
